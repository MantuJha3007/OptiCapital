...
export const CLASS_META: Record<AssetClass, { label: string; short: string; color: string }> = {
  EQUITY: { label: "Equity", short: "EQ", color: "var(--color-ac-equity, #3b82f6)" },
  GOV_BONDS: { label: "Government Bonds", short: "GOV", color: "var(--color-ac-gov, #10b981)" },
  CORP_BONDS: { label: "Corporate Bonds", short: "CORP", color: "var(--color-ac-corp, #8b5cf6)" },
  GOLD: { label: "Gold", short: "GOLD", color: "var(--color-ac-gold, #f59e0b)" },
  CASH: { label: "Cash", short: "CASH", color: "var(--color-ac-cash, #6b7280)" },
};
